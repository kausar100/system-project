...
public class SecondYearSecondSemester extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_year_second_semester);
        this.setTitle("second year second semester");

        dl = (DrawerLayout) findViewById(R.id.syss);
