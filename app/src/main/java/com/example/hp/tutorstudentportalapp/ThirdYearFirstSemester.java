...
public class ThirdYearFirstSemester extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_year_first_semester);
        this.setTitle("third year first semester");

        dl = (DrawerLayout) findViewById(R.id.tyfs);
