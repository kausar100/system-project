...
public class FirstYearFirstSemester extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_year_first_semester);
        this.setTitle("first year first semester");

        dl = (DrawerLayout) findViewById(R.id.fyfs);
