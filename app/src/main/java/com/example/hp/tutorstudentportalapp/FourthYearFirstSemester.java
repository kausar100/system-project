...
public class FourthYearFirstSemester extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourth_year_first_semester);
        this.setTitle("fourth year first semester");

        dl = (DrawerLayout) findViewById(R.id.fouryfs);
